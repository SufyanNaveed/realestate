...
<div class="container padding-top40 padding-bot40">
	<div class="detail-product1 " style="background: #f5f5f5;border-radius: 7px;    border: solid 1px #ebebeb;">
		<div class="heading">Kindly fill the following form so that we can suggest you the right property options for you.</div>
		<div class="contain-wrapp padding-top40 padding-bot40">	
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<form action="<?= base_url('home/insert_purchaser_guide')?>" method="post">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-5">
									<div class="row">
										<div class="col-md-3">
											<label for="contact">Sector:<span class="red">(Optional)</span></label>
										</div>
										<div class="col-md-9">
											<select class="form-control" name="sector" id="sector_id">
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-3">
									<label for="contact">Street: <span class="red">(Optional)</span></label>
								</div>
								<div class="col-md-4">
									<div class="row">
										<div class="col-md-12">
								...
								<div class="col-md-5">
									<div class="row">
										<div class="col-md-3">
											<label for="contact">Plot: <span class="red">(Optional)</span></label>
										</div>
										<div class="col-md-9">
