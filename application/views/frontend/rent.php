					...
					<div class="loc_slider lt_slide vs1 vs_a rsDefault" >
						...
						<ul>
							<?php for($y=0; $y <8; $y++){ if(($counter/8) != (count($cities)/8)) {?>
								<li><a href="<?= base_url('home/city_posts_rent/'.$cities[$counter]['city_id'] )?>"><?= $cities[$counter]['city_name'] ?>
									<span class='r count'>
										(<?php 
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <!--<div class="tab-pane fade active in" id="buy">
                        	<form method="post" action="<?= base_url('home/rent_buy')?>">
								<div class="row">
									<div class="col-md-6">
										<p>
											<div class="col-md-2">
										...
										<p>
											...
											<div class="col-md-10">
												<select name="type" id="tab_type" autocomplete="off">
													<option value="" data-cval="All Homes" selected="" class="sb_type_bold">--------- Homes ---------</option>
													<option value="House" class="tabbed">Houses</option>
													<option value="Flat" class="tabbed">Flats</option>
													<option value="Upper Portion" class="tabbed">Upper Portions</option>
													<option value="Lower Portion" class="tabbed">Lower Portions</option>
													<option value="Farm House" class="tabbed">Farm Houses</option>
													<option value="Room" class="tabbed">Rooms</option>
													<option value="Penthouse" class="tabbed">Penthouse</option>
													...
													<option value="" data-cval="All Commercial" class="sb_type_bold">--------- Commercial ---------</option>
													<option value="Office" class="tabbed">Offices</option>
													<option value="Shop" class="tabbed">Shops</option>
													<option value="Ware House" class="tabbed">Warehouses</option>
													<option value="Factory" class="tabbed">Factories</option>
													<option value="Building" class="tabbed">Buildings</option>
													<option value="Other" class="tabbed">Other</option>
												</select>
											</div>
										</p>
										<p>
											<div class="col-md-2">
												<img src="<?= base_url('assets/frontend/img/sleeping-bed-silhouette.png')?>">
											</div>
											<div class="col-md-10">
												<div class="input">
													<select name="bedroom" id="tab_beds" autocomplete="off">
										...
										<div class="rangebox">
											<div class="row">
												<div class="input">
													...
													<div class="col-md-9">
														<input id="price_1" class="range" type="text" name="price_from" autocomplete="off" title="title">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="input">
													...
													<div class="col-md-9">
														<input id="price_1" class="range" type="text" name="price_to" autocomplete="off" title="title">
													</div>
												</div>
											</div>
										</div>
		                ...
		                <div class="tab-pane fade active in" id="rent">
                        	<form method="post" action="<?= base_url('home/search_rent')?>">
								<div class="row">
									<div class="col-md-6">
										<p>
											<div class="col-md-2">
									...
									<div class="col-md-6">
										<p>
											...
											<div class="col-md-10">
												<select name="type" id="tab_type" autocomplete="off">
													...
													<option value="all_house" data-cval="All Homes" class="sb_type_bold">--------- Homes ---------</option>
													<option value="House" class="tabbed">Houses</option>
													<option value="Flat" class="tabbed">Flats</option>
													<option value="Upper Portion" class="tabbed">Upper Portions</option>
													<option value="Lower Portion" class="tabbed">Lower Portions</option>
										...
										<p>
											<div id="tab_bedes" style="display:none;" >
												<div class="col-md-2">
													<img src="<?= base_url('assets/frontend/img/sleeping-bed-silhouette.png')?>">
												</div>
												<div class="col-md-10">
...
<br><br><div style="font-size:50px; font-family:all; color:#00aced; text-align: center;line-height:1 !important;">"We Believe in Fair & Transparent Deal"<br><br></div>
	...
	<div class="contain-wrapp padding-bot40">
		<div class="container">
			...
			<div class="row">
				<div class="title">Pakistan Properties To Rent</div>
				<?php foreach($cities as $row){ ?>
					<div class="col-md-4 col-sm-6">
						<ul>
							<li style="font-size:12px;"><a href="<?= base_url('home/city_posts_rent/'.$row['city_id'])?>"><?= $row['city_name']; ?></a>
								<span>(<?php 
										$this->db->from('post_ads');
			...
			<div class="row">
				<div class="title">Most Popular Locations</div>
				<div class="col-md-4 col-sm-6">
					...
					<ul>
						<?php foreach($query as $rows){?>
							<li><a href="<?= base_url('home/society_posts_rent/'.$rows['society_id'])?>" title="Houses For Sale in DHA Defence">Plots For Sale in <?= $rows['society_name'] ?></a>
								<span>(<?php 
										$this->db->from('post_ads');
				...
				<div class="col-md-4 col-sm-6">
					...
					<ul>
						<?php foreach($query as $rows){?>
							<li><a href="<?= base_url('home/society_posts_rent/'.$rows['society_id'])?>" >Plots For Sale in <?= $rows['society_name'] ?></a>
								<span>(<?php 
										$this->db->from('post_ads');
										$this->db->where('city',$rows['city']);
										$this->db->where('society',$rows['society_id']);
...
$('#tab_type').change(function(){     
	var tab = $('#tab_type').val();
	//alert(tab);
	if(tab == "all_house" || tab == "House" || tab == "Flat" || tab == "Upper Portion" || tab == "Lower Portion" || tab == "Farm House" || tab == "Room" || tab == "Penthouse") 
	{
		$("#tab_bedes").show();
	}else {
		$("#tab_bedes").hide();
