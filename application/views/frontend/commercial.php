				...
				<?php $counter = 0;
					...
					<ul>
						<?php for($y=0; $y <8; $y++){ if(($counter/8) != (count($cities)/8)) {?>
							<li><a href="<?= base_url('home/city_posts_commercial/'.$cities[$counter]['city_id'] )?>"><?= $cities[$counter]['city_name'] ?>
								<span class='r count'>
									(<?php 
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="buy">
                        	<form method="post" action="<?= base_url('home/commercial_buy')?>">
								<div class="row">
									<div class="col-md-6">
										<p>
											<div class="col-md-2">
		                ...
		                <div class="tab-pane fade" id="rent">
                        	<form method="post" action="<?= base_url('home/commercial_rent')?>">
								<div class="row">
									<div class="col-md-6">
										<p>
											<div class="col-md-2">
...
<br><br><div style="font-size:50px; font-family:all; color:#00aced; text-align: center; line-height:1 !important;">"We Believe in Fair & Transparent Deal"<br><br></div>
	...
	<div class="contain-wrapp padding-bot40">
		<div class="container">
			...
			<div class="row">
				<div class="title">Popular Commercial Properties</div>
				<?php foreach($cities as $row){ ?>
					<div class="col-md-4 col-sm-6">
						<ul>
							<li style="font-size:12px;"><a href="<?= base_url('home/city_posts_commercial/'.$row['city_id'])?>"><?= $row['city_name']; ?></a>
								<span>(<?php 
										$this->db->from('post_ads');
			...
			<div class="row">
				<div class="title">Most Popular Commercial Locations</div>
				<div class="col-md-4 col-sm-6">
					...
					<ul>
						<?php foreach($query as $rows){?>
							<li><a href="<?= base_url('home/society_posts_commercial/'.$rows['society_id'])?>" title="Houses For Sale in DHA Defence">Plots For Sale in <?= $rows['society_name'] ?></a>
								<span>(<?php 
										$this->db->from('post_ads');
				...
				<div class="col-md-4 col-sm-6">
					...
					<ul>
						<?php foreach($query as $rows){?>
							<li><a href="<?= base_url('home/society_posts_commercial/'.$rows['society_id'])?>" >Plots For Sale in <?= $rows['society_name'] ?></a>
								<span>(<?php 
										$this->db->from('post_ads');
										$this->db->where('city',$rows['city']);
										$this->db->where('society',$rows['society_id']);
