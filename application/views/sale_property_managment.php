...
<?php include_once('includes/property_managment_sidebar.php'); ?>
		...
		<?php $value=""; ?>
		<?php if($current_link == base_url('dashboard/active_sale_property_management')){ 
				$value =  "Active";
			}else if($current_link == base_url('dashboard/edited_sale_property_management')){ 
				$value =  "Edited";
			}else if($current_link == base_url('dashboard/pending_sale_property_management')){ 
				$value =  "Pending";
			}else if($current_link == base_url('dashboard/expired_sale_property_management')){ 
				$value =  "Expired";
			}else if($current_link == base_url('dashboard/deleted_sale_property_management')){ 
				$value =  "Deleted";
			}else if($current_link == base_url('dashboard/rejected_sale_property_management')){ 
				$value =  "Rejected"; }
		?>	
		...
		<div class="col-lg-9 sidediv property-form">
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#prof2"><?= $value; ?> Listing for Sale</a></li>
			</ul>
			<div class="tab-content">
