...
<?php include_once('includes/property_managment_sidebar.php'); ?>
		...
		<?php $value=""; ?>
		<?php if($current_link == base_url('dashboard/active_property_management')){ 
				$value =  "Active";
			}else if($current_link == base_url('dashboard/edited_property_management')){ 
				$value =  "Edited";
			}else if($current_link == base_url('dashboard/pending_property_management')){ 
				$value =  "Pending";
			}else if($current_link == base_url('dashboard/expired_property_management')){ 
				$value =  "Expired";
			}else if($current_link == base_url('dashboard/deleted_property_management')){ 
				$value =  "Deleted";
			}else if($current_link == base_url('dashboard/rejected_property_management')){ 
				$value =  "Rejected"; }
		?>	
		...
		<div class="col-lg-9 sidediv property-form">
			<ol class="breadcrumb">
				<li><a href="<?= base_url('dashboard/active_property_management')?>">Property Management</a></li>
				<li><?= $value ?></li> 
				<li>All Listing</li>
			</ol>
			...
			<ul class="nav nav-tabs">
				<li class="active">
					<a data-toggle="tab" href="#prof2"><?= $value; ?> Listing for Sale</a>
				</li>
			</ul>
			<div class="tab-content">
				...
				<br>
					<form class="form-horizontal">
						...
						<div class="col-sm-12">
							<div class="col-sm-4">
								<h6 style="color:grey">Total Listings: <?= count($sale_listing)?></h6>
							</div>
							<div class="col-sm-8">
								<nav aria-label="...">
									<ul class="pagination">
						...
						<table class="table-bordered" style="width:100%">
							...
							<?php foreach($sale_listing as $row){?>
							<tr>
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#prof2"><?= $value; ?> Listing for Rent</a></li>
			</ul>
			<div class="tab-content">
				<div id="prof2" class="tab-pane fade in active">
					<br>
					...
					<form class="form-horizontal">
						...
						<div class="col-sm-12">
							<div class="col-sm-4">
								<h6 style="color:grey">Total Listings: <?= count($rent_listing)?></h6>
							</div>
							<div class="col-sm-8">
								<nav aria-label="...">
									<ul class="pagination">
						...
						<table class="table-bordered" style="width:100%">
							...
							<?php foreach($rent_listing as $row){?>
							<tr>
								<td><?= $row['post_ads_id']; ?></td>
								<td>
									<?php if($row['frst_option'])
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#prof2"><?= $value; ?> Listing Wanted</a></li>
			</ul>
			<div class="tab-content">
				<div id="prof2" class="tab-pane fade in active">
					<br>
...
<?php include_once('includes/footer.php'); ?>
<?php } elseif ($roles[9] == 10){ redirect('dashboard/post_listing');} else { redirect('dashboard');}?>