...
<?php include_once('includes/property_managment_sidebar.php'); ?>
		...
		<?php $value=""; ?>
		<?php if($current_link == base_url('dashboard/active_rent_property_management')){ 
				$value =  "Active";
			}else if($current_link == base_url('dashboard/edited_rent_property_management')){ 
				$value =  "Edited";
			}else if($current_link == base_url('dashboard/pending_rent_property_management')){ 
				$value =  "Pending";
			}else if($current_link == base_url('dashboard/expired_rent_property_management')){ 
				$value =  "Expired";
			}else if($current_link == base_url('dashboard/deleted_rent_property_management')){ 
				$value =  "Deleted";
			}else if($current_link == base_url('dashboard/rejected_rent_property_management')){ 
				$value =  "Rejected"; }
		?>	
