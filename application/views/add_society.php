...
<?php include_once('includes/extra_sidebar.php'); ?>
		...
		<div class="col-lg-9">
			...
			<ul class="nav nav-tabs">
				<li class="active">
					<a data-toggle="tab" href="#home">Add Society</a> 
				</li>
			</ul>
			...
			<div class="tab-content">
				<div id="home" class="tab-pane fade in active">
					...
					<br>
					<br>
					<form class="form-horizontal" method="post" action="<?= base_url('dashboard/insert_society')?>">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="society_name" required class="form-control" placeholder = "Enter Society Name">
							</div>
						</div>
