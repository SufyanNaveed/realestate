		...
		<div class="col-lg-9">
			...
			<div class="tab-content">
				<div id="home" class="tab-pane fade in active">
					...
					<br>
					<br>
					<form class="form-horizontal" method="post" action="<?= base_url('dashboard/update_phase')?>">
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="country_id" required class="form-control" id="country_id"style="background-color:white;">
									<option value="<?= $phase['country_id'] ?>"><?= $phase['country_name'] ?></option>
						...
						<div class="form-group" id="city">
							...
							<div class="col-md-4">
								<select name="city_id" id="city_id" required class="form-control"  style="background-color:white;">
									<option value="<?= $phase['city_id'] ?>"><?= $phase['city_name'] ?></option>
						...
						<div class="form-group" id="society">
							...
							<div class="col-md-4">
								<select name="society_id" id="society_id" required class="form-control"  style="background-color:white;">
									<option value="<?= $phase['society_id'] ?>"><?= $phase['society_name'] ?></option>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" name="phase_name" required value="<?= $phase['phase_name'] ?>" class="form-control" placeholder = "Enter Phase Name">
							</div>
						</div>
